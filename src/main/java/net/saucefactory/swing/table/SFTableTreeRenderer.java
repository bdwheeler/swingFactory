...
public class SFTableTreeRenderer  extends JTree implements TableCellRenderer {
  
	private SFTableTree parentTable;
  private int currentRow;
  private boolean dirtyPaint = true;

  public SFTableTreeRenderer(SFTableTree table, TreeModel model) {
    super(model);
    parentTable = table;
