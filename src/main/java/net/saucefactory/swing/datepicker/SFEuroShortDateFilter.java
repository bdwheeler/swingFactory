...
public class SFEuroShortDateFilter
  ...
  public static SFDateTextFieldGroup getDateTextFieldGroup(SFDateTextField textField) {
    try {
      return ((SFEuroShortDateFilter)textField.getDocument()).getDateTextFieldGroup();
    } catch (Exception e) {
      return null;
    }
  }
  ...
  public static void install(JTextField textField) {
    SFEuroShortDateFilter filter = new SFEuroShortDateFilter();
