...
public class SFUSShortDateFilter
  ...
  public static SFDateTextFieldGroup getDateTextFieldGroup(SFDateTextField textField) {
    try {
      return ((SFUSShortDateFilter)textField.getDocument()).getDateTextFieldGroup();
    } catch (Exception e) {
      return null;
    }
  }
  ...
  public static void install(JTextField textField) {
    SFUSShortDateFilter filter = new SFUSShortDateFilter();
