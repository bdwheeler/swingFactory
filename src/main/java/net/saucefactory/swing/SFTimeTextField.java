...
import java.awt.*;
import javax.swing.*;
import net.saucefactory.text.SFTimeFilter;
import java.util.Date;

public class SFTimeTextField extends JTextField {
  SFTimeFilter filter = new SFTimeFilter(true);

  public SFTimeTextField() {
