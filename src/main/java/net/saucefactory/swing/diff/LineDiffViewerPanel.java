...
import net.saucefactory.swing.event.ScrollSynchronizer;
import net.saucefactory.text.diff.Diff;
import net.saucefactory.text.diff.DiffUtility;


public class LineDiffViewerPanel extends JPanel {
  ...
  public LineDiffViewerPanel(String text1_, String text2_, int lineLength_) throws Exception {
    super();
    init(text1_, "Initial Text", text2_, "Comparison Text", lineLength_);
    setText();
  }

  public LineDiffViewerPanel(String text1_, String text1Label_, String text2_, String text2Label_, int lineLength_) throws Exception {
    super();
