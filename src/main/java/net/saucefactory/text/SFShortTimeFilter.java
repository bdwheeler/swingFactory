...
public class SFShortTimeFilter extends PlainDocument implements FocusListener {
  ...
  public SFShortTimeFilter() {

  }

  public SFShortTimeFilter(boolean doLocal_) {
    doLocal = doLocal_;
  }
  ...
  public void insertString(int offset, String str, AttributeSet a) throws BadLocationException {
    ...
    switch(offset) {
      ...
      case 1: {
        ...
        if(pre == 1 && Integer.parseInt(str) > 2) {
          beep();
          return;
        }
  ...
  public static void install(JTextField textField, boolean keepFocus) {
    SFShortTimeFilter filter = new SFShortTimeFilter();
  ...
  public static void install(JTextField textField, boolean keepFocus, boolean doLocal) {
    SFShortTimeFilter filter = new SFShortTimeFilter(doLocal);
    textField.setDocument(filter);
    filter.requestFocus = keepFocus;
    textField.addFocusListener(filter);
  }
